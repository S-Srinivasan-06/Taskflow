      ...
      <div className="flex min-w-0 max-w-[calc(100%_-_5.5rem)] items-center gap-1.5 sm:max-w-none sm:gap-3">
        ...
        <div ref={accountRef} className="relative">
          <button
            ...
            aria-haspopup="menu"
            className="flex max-w-[30vw] items-center gap-1 sm:max-w-56 sm:gap-2 border-l border-white/30 pl-3 text-left font-mono text-[10px] font-bold uppercase tracking-wide text-stone-300 hover:text-white"
          >

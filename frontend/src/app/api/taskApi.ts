...
export const taskApi = {
  searchTasks(params: { search?: string; category?: string; quickFilter?: string; date?: string; startDate?: string; endDate?: string; sort?: string; page?: number; size?: number }, signal?: AbortSignal) {
  ...
  getByMonth: (year: number, month: number) => request<Task[]>('/tasks/calendar?year=' + year + '&month=' + month),
